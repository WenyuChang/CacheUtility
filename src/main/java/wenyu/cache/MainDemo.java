...
import wenyu.cache.EHCacheUtility.EHCache;
import wenyu.cache.EHCacheUtility.EHCacheUnit;
import wenyu.cache.EHCacheUtility.Refresher;
import wenyu.cache.MyCacheUtility.MyCache;
...
public class MainDemo {
	...
	private static void myCacheEnrty() {
		...
		cache.addEntry("mykey", new wenyu.cache.MyCacheUtility.Refresher() {
